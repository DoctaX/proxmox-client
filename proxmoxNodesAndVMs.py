...
class proxmoxData:
    def getProx(self, DNSName, user, password, port, csv_filename=None):
    ...
    def data_processing(self, csv_filename, vm_data):
        ...
        for vm, data in vm_data.items():
            ...
            rows.append(csvdata)
        output = proxmoxData()
        output.output_to_file(csv_filename, rows)
...
data = proxmoxData()
data.getProx('pmx.nsis-au.nxcrd.net', 'cajaje@pve', 'c@6Un8r1T', 443, "C:\\nothing_file\\test29.csv")
